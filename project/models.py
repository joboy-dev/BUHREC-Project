...
class Project(models.Model):
    ...
    justification = CKEditor5Field(default='', null=False, blank=True, max_length=50000)
    objectives = CKEditor5Field(default='', null=False, blank=True, max_length=35000)
    hypothesis = CKEditor5Field(default='', null=True, blank=True, max_length=20000)
    literature_review = CKEditor5Field(default='', null=False, blank=True, max_length=100000)
    materials_and_methods = CKEditor5Field(default='', null=False, blank=True, max_length=150000)
    procedure = CKEditor5Field(default='', null=False, blank=True, max_length=50000)
